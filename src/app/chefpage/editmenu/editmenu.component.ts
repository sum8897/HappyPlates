...
export class EditmenuComponent implements OnInit {
  ...
  ionViewWillEnter(){
    ...
    console.log(this.selectedFoodCategory_id);
...
foodChange(e:any) {
  ...
  console.log('food type: ' + this.selectedFoodCategory_id);
}
  handleChange(e:any) {
    this.selectedCategory_id=e.detail.value
    console.log('food category: ' + this.selectedCategory_id);
  }
